from improbable_cpr.generators import RunningNumberGenerator, Gender
import pytest
...
@pytest.mark.parametrize(
        "year,valid_digits",
        [(1858, [5,6,7,8]), (1899, [5,6,7,8]), (1900, [0,1,2,3]), (1937, [0,1,2,3,4,9]), 
         (1999, [0,1,2,3,4,9]), (2000, [4,5,6,7,8,9]), (2036, [4,5,6,7,8,9]), (2037, [5,6,7,8]), (2057, [5,6,7,8])]
)
